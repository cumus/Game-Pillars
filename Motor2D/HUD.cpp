...
bool Hud::Awake(pugi::xml_node& conf)
{
	...
	/* TODO 1: load a new minimap: new Minimap(); and 
	call the minimap's Load(pugi::xml_node& conf) to load its resources.*/
...
bool Hud::Update(float dt)
{
	...
	/* TODO 6: Call the minimap Update() function
	Make sure to only call it if minimap is NOT nullptr!*/

	return false;
}

void Hud::PrintMinimap()
{
	/* TODO 3: Call the minimap Draw() function
	Make sure to only call it if minimap is NOT nullptr!*/
	if (minimap != nullptr)
		minimap->Draw();
}
